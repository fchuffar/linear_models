...
1. __CODALAB__ Les TP seront organisés dès la première session autour de plusieurs data challenges sur la plateforme codalab, je vous invite à vous connecter ici maintenant pour gagner du temps
...
[Questionnaire Séance 1](https://forms.gle/tk5n2FZVba4iv28j7) : à rendre pour le dimanche 14
...
## Organisation prévisionnelle
  ...
  - *data challenge 1* (séance 4, Magali Richard)
  ...
  - Introduction à la régression logistique (séance 5, Florent Chuffart) 
  - GLM (séance 6, Magali Richard)
   - *data challenge 2* (séance 7, Magali Richard)
   - Regression de poisson (séance 8, Florent Chuffart)
