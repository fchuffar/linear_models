...
## Organisation prévisionnelle
  ...
  - Régression linéaire simple 2 (séance 2, Florent Chuffart)
  - Régression linéaire multiple (séance 3, Florent Chuffart)
  ...
  - ANOVA (séance 5, Florent Chuffart) 
...
```{r child = "0Bib_cours_modlin.Rmd", eval=TRUE}
```
