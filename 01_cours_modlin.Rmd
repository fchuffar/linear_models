...
L’objectif de cette section est : 
  - d’introduire la **régression linéaire** comme modèle statistique
  - de définir les **tests de Student et de Fisher** comme des procédures permettant d’interoger le modèle.
