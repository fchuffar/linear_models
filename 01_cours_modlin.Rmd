...
La valeur critique du test, notée $c_\alpha$ est lue dans une table de la loi de Student.
...
alors la variable aléatoire $t_{\widehat\beta_1,n-2} = \frac{\widehat\beta_1}{s_{\widehat\beta_1}}$, *i.e*, l’effet de la variable $x$ extimé à partir des observations *"réduit"* de la *"variabilité"* observée sur cet estimateur, 
suit une la loi de Student à $n-2$ dégré de liberté notée $\mathcal{T}_{n-2}$ **en raison des conditions d’applications du test**.
