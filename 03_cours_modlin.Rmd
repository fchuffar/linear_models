...
p = plot(d$conc_fact, d$uptake, las=2, main=paste0("uptake~conc_fact R^2=", signif(summary(m3)$r.squared,3)))
conc_fact = jitter(as.numeric(d$conc_fact))
arrows(conc_fact, d$uptake, conc_fact, d$uptake-m3$residuals, col=adjustcolor(4, alpha.f=0.5), length=0.1)
...
- hypothèse nulle $H_0,\mu_1=\mu_2=...=\mu_I$
- hypothèse alternative $H_1, \text{les moyennes } \mu_i \text{ ne sont pas toutes égales.}$
...
*Remarque* : on peut aussi écrire ce test à l’aide d’une table disjonctif : 
