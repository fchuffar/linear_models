...
## Organisation prévisionnelle
  ...
  - *data challenge expred3.0* (séance 3, Magali Richard)
      - codalab : https://www.codabench.org/competitions/1692/?secret_key=439a40e9-9de7-4336-918f-ac983d5dd22c
      - fin de séance, 1 compte rendu par équipe : https://github.com/fchuffar/starting_kit_epiclock1.0
  - ANOVA (séance 4, Florent Chuffart) 

     
  - Introduction à la régression logistique (séance 5, Florent Chuffart) 
  - *data challenge 2 histpred2.0* (séance 6, Magali Richard)
      - https://competitions.codalab.org/competitions/25357?secret_key=3a54cc71-6bbf-4e30-bf98-e9ec502853bf
       
  - Introduction à la regression de poisson (séance 7, Florent Chuffart)
