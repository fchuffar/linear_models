...
Dans l’exemple suivant, on voit l’effet de l’ordre des observation sur l’autocorrélation.
...
**Problèmes**, quand $p > n$ :
  - la solution du système linéaire des moindre carré n’est pas unique.
...
2.1) Etudier la corrélation des variable à l’aide du code suivant. Commenter les graphiques obtenus.

```{r echo=TRUE, fig.width=9, fig.height=9, eval=FALSE}
pairs(d, gap=0)
